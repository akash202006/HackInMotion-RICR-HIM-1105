...
Handles AI-powered analysis of inventory data using Google Gemini API
"""
...
class GeminiAnalyzer:
    ...
    This class provides AI-powered analysis of inventory data, including:
    ...
    def generate_insights(products: List[Dict[str, Any]]) -> Dict[str, str]:
        """
        Generate AI insights from inventory data.
                ...
                try:
                    ...
                    for model_name in model_options:
                        try:
                            ...
                            text = client.generate_text(prompt, model_name=model_name)
                            if text:
                                insights = _parse_gemini_response(text)
                                if insights and any(insights.get(key) for key in insights):
                                    return insights
